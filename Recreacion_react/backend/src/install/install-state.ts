...
/**
 * Indica que el asistente de instalación ya terminó correctamente (BD + seed + `.env`).
 *
 ...
 * El asistente aplica `prisma migrate deploy` tras vaciar la base (mismo enfoque que `services/database`).
 */
