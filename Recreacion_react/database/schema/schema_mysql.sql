-- Club360 MVP (Nest): solo tablas usadas por TypeORM — gestión de socios, staff y ajustes.
-- Espejo lógico de `backend/prisma/schema.prisma` (migraciones Prisma). Si cambias tablas, actualiza Prisma + entidades + este archivo.
SET NAMES utf8mb4;
