...
CREATE TABLE `gym_member` (
    ...
    INDEX `idx_gym_member_assign_staff`(`assign_staff_mem`),
    INDEX `idx_gym_member_name`(`first_name`, `last_name`),
    INDEX `idx_gym_member_username`(`username`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `membership_payment` (
    ...
    INDEX `idx_membership_payment_end_date`(`end_date`),
    PRIMARY KEY (`mp_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `club_access_log` (
    ...
    INDEX `idx_club_access_log_date_outcome`(`access_date`, `outcome`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
