...
-- Especializaciones: Entrenador, Nutricionista, Cajero, Stock.
-- Planes: dieta/rutina general (fuente única) + personal opcional (Luis).
...
INSERT INTO `gym_member` (
  ...
  `s_specialization`, `subscribe_nutrition_general`, `subscribe_training_general`
) VALUES
(
  1, 1, 'administrator', NULL, 'Admin', '', 'Club360',
  'admin',
  '$2b$10$am//pywdU8mUGWXufZglo.MbjgjiMX22hNdU5a1K93sFXb8BOkGJm',
  'admin@local.test', NULL, NULL, CURDATE(), NULL, NULL, 1, 1
),
(
...
INSERT INTO `training_routine` (`id`, `title`, `description`, `difficulty_level`, `is_general`) VALUES
(1, 'Rutina general del club', 'Rutina compartida (fuente única) para socios suscritos a general', 'media', 1),
(2, 'Rutina personal demo', 'Plantilla para asignación personalizada (Luis)', 'media', 0);
...
INSERT INTO `nutrition_plan_general` (
  `id`, `title`, `is_published`, `valid_from`, `valid_to`, `meals_schedule_json`
) VALUES (
  1, 'Dieta general del club', 1, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 365 DAY),
  '[{"weekday":1,"hour":8,"event":"Desayuno general","dish":"Tostadas integrales con huevo y fruta.","ingredients":[{"name":"Pan integral","quantity":"2 rebanadas"},{"name":"Huevo","quantity":"1 unidad"},{"name":"Fruta de temporada","quantity":"1 pieza"}]},{"weekday":1,"hour":13,"event":"Almuerzo general","dish":"Pollo a la plancha con arroz y verduras."},{"weekday":3,"hour":8,"event":"Desayuno general"},{"weekday":5,"hour":13,"event":"Almuerzo general"}]'
);
...
(
  1, 4, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 90 DAY),
